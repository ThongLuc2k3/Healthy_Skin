...
export const ASSISTANT_TOOL_SCHEMAS = [
  ...
  { name: 'create_request', description: 'Đăng yêu cầu hỗ trợ mới; cần xác nhận. Trao đổi ngắn mặc định 30 phút.', parameters: object({ kind: { type:'STRING',enum:['free','paid','exchange'] }, universityId:string(), courseName:string(), title:string(), description:string(), durationMinutes:integer(), startsAt:string(), amountVnd:integer(), offeredDescription:string(), deliveryMode:{type:'STRING',enum:['online']} }, ['kind','title','description']) },
