...
export function LeafIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path
        d="M5 19c8 0 14-6 14-14 0 0-13-2-14 8-.6 4.2 0 6 0 6z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M5 19c0-4 2-8 6-10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  )
}
...
export function FlameIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path
        d="M12 3c1 3-3 4-3 7.5a3 3 0 0 0 6 0c0-1-.5-1.8-1-2.5.8.3 2.5 1.7 2.5 4.5a5 5 0 0 1-10 0c0-4.5 4-5 3-9.5z"
        fill="currentColor"
      />
    </svg>
  )
...
export function StarIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <path d="M12 3l2.6 5.6 6.1.6-4.6 4.1 1.3 6-5.4-3.1-5.4 3.1 1.3-6-4.6-4.1 6.1-.6L12 3z" fill="currentColor" />
    </svg>
  )
}
...
export function StethoscopeIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path
        d="M6 4v5a4 4 0 0 0 8 0V4M6 4H4.5M14 4h1.5"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path d="M10 13v2a5 5 0 0 0 10 0v-1.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <circle cx="20" cy="11.5" r="1.5" stroke="currentColor" strokeWidth="2" />
    </svg>
  )
}
...
export function TrophyIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path d="M8 5H5v1a3 3 0 0 0 3 3M16 5h3v1a3 3 0 0 1-3 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M12 11v4M9 20h6M10 15h4l1 5H9l1-5z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function WalletIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path d="M4 7a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v1H6a2 2 0 0 0-2 2V7z" stroke="currentColor" strokeWidth="2" />
      <path d="M4 10a2 2 0 0 1 2-2h13v9a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-7z" stroke="currentColor" strokeWidth="2" />
...
export function GamepadIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path
        d="M8 9h8a4 4 0 0 1 3.9 4.9l-.6 2.3a2 2 0 0 1-3.2 1.1l-1.8-1.5a3 3 0 0 0-3.8 0l-1.8 1.5a2 2 0 0 1-3.2-1.1l-.6-2.3A4 4 0 0 1 8 9z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path d="M9 12v3M7.5 13.5h3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
...
export function HomeIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h4a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h4a1 1 0 001-1V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function MapIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <path d="M9 20l-6-3V4l6 3m0 13l6-3m-6 3V7m6 10l6 3V7l-6-3m0 13V4m0 0L9 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
